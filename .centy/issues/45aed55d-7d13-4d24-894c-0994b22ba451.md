...
# Implement clippy::ref_as_ptr lint

## Overview

Implement the [`clippy::ref_as_ptr`](https://rust-lang.github.io/rust-clippy/master/index.html#ref_as_ptr) pedantic lint as a Dylint lint.

## Tasks

- Study the clippy reference implementation for `clippy::ref_as_ptr`
...
- Lint group: **pedantic**
- Clippy reference: <https://rust-lang.github.io/rust-clippy/master/index.html#ref_as_ptr>

## Acceptance Criteria

- Lint correctly detects the pattern described by `clippy::ref_as_ptr`

...
# Implement clippy::ptr_as_ptr lint

## Overview

Implement the [`clippy::ptr_as_ptr`](https://rust-lang.github.io/rust-clippy/master/index.html#ptr_as_ptr) pedantic lint as a Dylint lint.

## Tasks

- Study the clippy reference implementation for `clippy::ptr_as_ptr`
...
- Lint group: **pedantic**
- Clippy reference: <https://rust-lang.github.io/rust-clippy/master/index.html#ptr_as_ptr>

## Acceptance Criteria

- Lint correctly detects the pattern described by `clippy::ptr_as_ptr`

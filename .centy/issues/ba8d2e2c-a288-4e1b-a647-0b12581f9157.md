...
# Implement clippy::if_not_else lint

## Overview

Implement the [`clippy::if_not_else`](https://rust-lang.github.io/rust-clippy/master/index.html#if_not_else) pedantic lint as a Dylint lint.

## Tasks

- Study the clippy reference implementation for `clippy::if_not_else`
...
- Lint group: **pedantic**
- Clippy reference: <https://rust-lang.github.io/rust-clippy/master/index.html#if_not_else>

## Acceptance Criteria

- Lint correctly detects the pattern described by `clippy::if_not_else`

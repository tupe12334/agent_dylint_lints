...
# Implement clippy::unused_self lint

## Overview

Implement the [`clippy::unused_self`](https://rust-lang.github.io/rust-clippy/master/index.html#unused_self) pedantic lint as a Dylint lint.

## Tasks

- Study the clippy reference implementation for `clippy::unused_self`
...
- Lint group: **pedantic**
- Clippy reference: <https://rust-lang.github.io/rust-clippy/master/index.html#unused_self>

## Acceptance Criteria

- Lint correctly detects the pattern described by `clippy::unused_self`
